...
// // MapNet toNetMap(Map map)
// // {
// //     MapNet net;

// //     net.running = map->running;
// //     net.width = map->width;
// //     net.height = map->height;
// //     net.tileSize = map->tileSize;

// //     memcpy(net.mapBuffer,
// //            map->mapBuffer,
// //            sizeof(net.mapBuffer));
...
//     FILE *file = fopen("link/Test.txt", "r");
//     if (!file) {
//         fprintf(stderr, "Failed to open map file.\n");
//         free(map);
//         return NULL;
