...
void SetAbilityItemState(AbilitySystem *system, int index, AbilityType type, float x, float y, int width, int height, bool active)
{
    ...
    system->items[index].x      = x;
    system->items[index].y      = y;
    system->items[index].width  = width;
...
float       AbilityItem_getY(AbilitySystem *system, int index)      { return system->items[index].y; }
int         AbilityItem_getWidth(AbilitySystem *system, int index)  { return system->items[index].width; }
int         AbilityItem_getHeight(AbilitySystem *system, int index) { return system->items[index].height; }
bool        AbilityItem_isActive(AbilitySystem *system, int index)  { return system->items[index].active; }